...
namespace LinkedList
{
    class Program
    {
        ...
        {
            IMyLinkedList<TestObject> listInterface = new MyLinkedList<TestObject>();

            TestObject tObj = new TestObject(-1);
            listInterface.AddFirst(tObj);

            for (int i = 0; i < 100; i++)
            {
                listInterface.AddLast(new TestObject(i));
            }

            for (int i = 0; i < 100; i++)
            { 
                Console.WriteLine(listInterface[i].ID);
            }
            Console.WriteLine("==============================");
            Console.WriteLine(listInterface.Counter);
            Console.WriteLine("==============================");
